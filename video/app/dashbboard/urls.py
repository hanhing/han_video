...
from .views.video import (ExternaVideo, ExternaVideoPost,
                          VideoSubView, VideoSubGet,
...
urlpatterns = [
    ...
    path('video/update/status/<int:video_id>', VideoUpdateStatus.as_view(), name='video_status'),
